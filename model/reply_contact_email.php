...
try {
    ...
    $mail->addAddress(!empty($_POST["email"]) ? $_POST["email"] : $receiverEmail);  // Add a recipient
    ...
    $mail->Body    = 'Dear '. $receiver. ", <br/>We are excited to welcome you to <b>CHIMKEN</b>! <br/>Your account has been successfully created. Here are your login details";
